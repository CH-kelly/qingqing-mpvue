        ...
        <div class="personal">
            <div class="info-card">  
                <div class="card-left">
                    ...
                    <div class="info">
                        <div class="info-desc">
                            <input class="weui-input-age" :value="headInfo.age"/>岁
                        </div>
                        <div class="info-line"></div>
                        <div class="info-desc">
                            <input class="weui-input-age" :value="headInfo.height"/>cm</div>
                        <div class="info-line"></div>
                        <div class="info-desc">
                            <input class="weui-input-age" :value="headInfo.constellation"/>
                        </div>
                    </div>
                </div>
