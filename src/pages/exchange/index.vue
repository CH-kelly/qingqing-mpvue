        ...
        <div class="index-center-background">
            ...
            <div class="index-center-content">
                ...
                <div class="content-input">
                    <input class="center-content-input" type="text" placeholder="请输入兑换码"  placeholder-style='color:rgba(170,170,170,1);font-size:26rpx'>
                </div>
                <div class="content-input">
                    <div class="center-button">立即兑换</div>
                </div>
            </div>
        </div>
